...
NOT change on the timer; clicking the panel SHALL still fetch the next verse. Toggling this setting SHALL
NOT itself change the currently displayed verse.
